...
- Only `brain artifacts --write` may replace the three generated files named in `08_Assets/artifacts/README.md`; generic writes, hand edits, hosting, and notifications remain forbidden.
