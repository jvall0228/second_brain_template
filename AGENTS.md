...
- Agents may write environment inventory notes to `10_Agents/environments/<env-slug>/` (agent-orientation output; landing convention in that directory's README).
