...
8. **Validate and commit:** `python3 10_Agents/tools/brain/brain.py validate`, then commit. Invocation directs the write to `03_Journal/periodic/<cadence>/`.
