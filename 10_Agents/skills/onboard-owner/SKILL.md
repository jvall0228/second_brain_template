...
5. **Seed real content.** Projects and responsibilities that surfaced in the interview become notes in `04_Projects/` and `05_Areas/` (1–2 each is plenty), built from [template-project](../../../09_Templates/template-project.md) / [template-area](../../../09_Templates/template-area.md).
