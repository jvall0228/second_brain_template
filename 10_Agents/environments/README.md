...
Environment-scoped notes: facts that are true of **one machine or execution environment** (a work laptop, a home desktop, a cloud container), not of the vault or the owner in general. The first resident is the orientation inventory produced by [agent-orientation](../skills/setup/agent-orientation/SKILL.md).
...
- **Never bootstrap-linked:** nothing here joins the bootstrap sequence in [AGENTS](../../AGENTS.md) or the global map in [INDEX](../../00_Meta/INDEX.md). Environment notes are pulled on demand by the skills that need them ([agent-orientation](../skills/setup/agent-orientation/SKILL.md) writes; [recommended-automations](../skills/recommended-automations/SKILL.md) and [self-maintenance](../skills/self-maintenance/SKILL.md) read) — they are facts about a place, not context every agent needs.
...
- [agent-orientation](../skills/setup/agent-orientation/SKILL.md) — the required output contract and inventory note template
